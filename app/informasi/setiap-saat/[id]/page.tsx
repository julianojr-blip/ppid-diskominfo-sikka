...
export default function DocumentDetailPage({ params }: { params: { id: string } }) {
  ...
  if (!document || document.category !== 'setiap-saat') {
    notFound();
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        <Link href="/informasi/setiap-saat" className="text-blue-600 hover:text-blue-800">
          &larr; Kembali ke Informasi Setiap Saat
        </Link>
      </div>
